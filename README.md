...
ring_shape = "square"                          # "square" | "diamond" | "circle" | "squircle" | "wings" | "layers" | "cycle" — geometry of the concentric bands
...
Set `ring_shape = "cycle"` to auto-rotate through square → diamond → circle → squircle → wings → layers every
