...
local PRESETS = {
    amber = {
        ...
        -- 21-stop skewed: stops clustered at dark end (detail), spread at bright end (snap).
        -- Power-curve distribution: pos = (i/20)^0.7 — bottom transitions 3.5× tighter than top.
        glow_rgb = {
            {8,8,8}, {35,13,13}, {94,0,0}, {147,61,0},
            {184,95,0}, {206,95,0}, {227,95,0}, {246,95,0},
            {255,100,0}, {255,109,0}, {255,118,0}, {255,126,0},
            {255,134,0}, {255,142,0}, {255,150,0}, {255,162,0},
            {255,177,0}, {255,191,0}, {255,212,0}, {255,233,0},
            {255,255,0},
        },
        overdrive_rgb = {
            {255,233,0}, {255,255,0},
