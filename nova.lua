...
local PRESET_PROFILES = {
    ...
    ["default"] = {
        ...
        overdrive = 0.86,  sustain = 0.82,  blend = true,
    ...
    ethereal = {
        ...
        overdrive = 0.94,  sustain = 0.9,  blend = true,
    ...
    plasma = {
        ...
        overdrive = 0.72,  sustain = 0.88,  blend = true,
    ...
    classic = {
        ...
        overdrive = 0.94,  sustain = 0.95,  blend = false,
